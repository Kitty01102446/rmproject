...
export default function Home() {
  ...
  return (
    <main className="home">
      ...
      <section className="hero-container">
        <div className="container">
          ...
          <div className="hero-float-text" data-aos="fade-up" data-aos-delay="400">
            ค้นพบสีเล็บที่ใช่และทรงเล็บที่ชอบ ผ่านเทคโนโลยี AI วิเคราะห์สีผิว
          </div>
      ...
      <section id="popular" style={{ padding: '100px 0' ,maxMidth: '1450px'}}>
        <div className="container">
      ...
      <section className="container" style={{ padding: '80px 0',maxMidth: '1450px' }}>
        <div className="category-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '40px' }}>
          {['STORES', 'AI COLOR', 'SHAPES'].map((item, idx) => (
            <div className="category-card" key={item} data-aos="fade-up" data-aos-delay={idx * 200}>
              ...
              <h4 style={{ fontFamily: 'Cormorant Garamond, Noto Sans Thai', fontSize: '24px', letterSpacing: '2px' }}>{item}</h4>
              <p style={{ fontSize: '14px', color: '#666' }}>รายละเอียดคำอธิบายบริการ...</p>
              <Link to="/AllStores" style={{ textDecoration: 'none', color: '#000', fontSize: '12px', fontWeight: 'bold' }}>เพิ่มเติม &rarr;</Link>
            </div>
          ))}
        </div>
      </section>
